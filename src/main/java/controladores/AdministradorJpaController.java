...
public class AdministradorJpaController implements Serializable {
    ...
    public AdministradorJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.emf = Persistence.createEntityManagerFactory("com.mycompany_mavencopy_war_1.0-SNAPSHOTPU");
        //this.utx = nose que hacer con esto
//this.utx = utx; se hace referencia a la unidad de persistencia
//this.emf = emf;
    }
